...
# Global assignments 
set_global_assignment -name TOP_LEVEL_ENTITY "|lanedetect_top"
set_global_assignment -name ROUTING_BACK_ANNOTATION_MODE NORMAL
set_global_assignment -name FAMILY "CYCLONE V"
set_global_assignment -name DEVICE "5CSEBA6U23I7"
set_global_assignment -section_id lanedetect_top -name EDA_DESIGN_ENTRY_SYNTHESIS_TOOL "SYNPLIFY"
...
set_global_assignment -name SDC_FILE "lanedetect_top.scf"
...
# Incremental Compilation
    ...
    # incremental compilation will be enabled
     set Design_Name "lanedetect_top" 
